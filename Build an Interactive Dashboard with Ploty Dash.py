...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Luanch Sites', 
        title='Successes by Luanch Sites')
        return fig
    else:
...
def get_success_payload_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        title = 'Correlation Between Payload & Mission Outcomes For All Sites')
        return fig
    else:
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site],
        x = 'Payload Mass (kg)', y = 'class',
        color = 'Booster Version Category',
        title = 'Correlation Between Payload & Mission Outcomes for: ' + entered_site)
        return fig
